    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4">
      ...
      <div className="hx-card relative w-full max-w-md border-white/10 bg-black/40 p-8 shadow-2xl shadow-black/40 backdrop-blur-xl">
        <div className="mb-6 text-center">
          ...
          <h1 className="text-2xl font-extrabold tracking-tight text-white">HEXAVANTE</h1>
          <p className="mt-1 text-sm text-slate-400">Entre com suas credenciais</p>
        </div>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            {oauth.isPending ? 'Abrindo...' : 'Entrar com Google'}
          </button>
          ...
          >
            ...
            {oauth.isPending ? 'Abrindo...' : 'Entrar com GitHub'}
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <button type="submit" className="hx-btn hx-btn-primary w-full" disabled={isSubmitting}>
